...
# p.init_index(
#     max_elements=n,
#     csr_path="/home/mr/big-ann-benchmarks/data/sparse/base_full.csr",
#     ef_construction=500,
#     M=16,
# )
# print("start")
# p.add_items(num_threads=32)
# p.save_index("/home/mr/hnswlib/sparse/indices/tmp/base_full")
# print("end")

p.load_index("/home/mr/hnswlib/sparse/indices/tmp/base_full", n)
p.set_ef(75)
...
data, indices, indptr, _ = mmap_sparse_matrix_fields("/home/mr/big-ann-benchmarks/data/sparse/queries.dev.csr")
  
I, _ = knn_result_read("/home/mr/big-ann-benchmarks/data/sparse/base_full.dev.gt")
start = time.time()
